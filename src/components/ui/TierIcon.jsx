...
function BronzeIcon() {
  return (
    <>
      <defs>
        <linearGradient id="ti-bz1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#EAA678" /><stop offset="100%" stopColor="#8B4513" /></linearGradient>
        <linearGradient id="ti-bz2" x1="0" y1="1" x2="1" y2="0"><stop offset="0%" stopColor="#C58356" /><stop offset="100%" stopColor="#5C3317" /></linearGradient>
      </defs>
      <polygon points="50,5 90,25 90,65 50,95 10,65 10,25" fill="url(#ti-bz1)" stroke="rgba(255,255,255,0.1)" strokeWidth="1" />
      ...
      <polygon points="50,25 70,35 70,55 50,70 30,55 30,35" fill="url(#ti-bz2)" />
    </>
  );
}
...
function SilverIcon() {
  return (
    <>
      <defs>
        <linearGradient id="ti-sv1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#D1D5DB" /><stop offset="50%" stopColor="#9CA3AF" /><stop offset="100%" stopColor="#4B5563" /></linearGradient>
      </defs>
      <polygon points="50,5 95,50 50,95 5,50" fill="url(#ti-sv1)" />
...
function GoldIcon() {
  return (
    <>
      <defs>
        <linearGradient id="ti-gd" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#FDE68A" /><stop offset="50%" stopColor="#F59E0B" /><stop offset="100%" stopColor="#B45309" /></linearGradient>
        <linearGradient id="ti-gd2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#FEF3C7" /><stop offset="100%" stopColor="#D97706" /></linearGradient>
      </defs>
      <path d="M 50 2 L 92 18 L 92 50 C 92 82 50 98 50 98 C 50 98 8 82 8 50 L 8 18 Z" fill="url(#ti-gd)" stroke="#FFFBEB" strokeWidth="1.5" strokeOpacity="0.5" />
      <path d="M 50 12 L 78 24 L 78 48 C 78 72 50 86 50 86 C 50 86 22 72 22 48 L 22 24 Z" fill="url(#ti-gd2)" />
...
function PlatinumIcon() {
  return (
    <>
      <defs>
        <linearGradient id="ti-pt" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#FFFFFF" /><stop offset="50%" stopColor="#CBD5E1" /><stop offset="100%" stopColor="#64748B" /></linearGradient>
        <linearGradient id="ti-pt2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#94A3B8" /><stop offset="100%" stopColor="#334155" /></linearGradient>
      </defs>
      <polygon points="50,0 85,35 50,100 15,35" fill="url(#ti-pt)" />
      <polygon points="50,0 85,35 50,45" fill="#FFFFFF" opacity="0.8" />
      <polygon points="50,0 15,35 50,45" fill="#94A3B8" opacity="0.5" />
      <polygon points="15,35 50,100 50,45" fill="url(#ti-pt2)" opacity="0.9" />
...
function DiamondIcon() {
  return (
    <>
      <defs>
        <linearGradient id="ti-di1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#EFF6FF" /><stop offset="100%" stopColor="#DBEAFE" /></linearGradient>
        <linearGradient id="ti-di2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#60A5FA" /><stop offset="100%" stopColor="#2563EB" /></linearGradient>
      </defs>
      <polygon points="30,20 70,20 90,40 10,40" fill="url(#ti-di1)" />
      ...
      <polygon points="10,40 90,40 50,95" fill="url(#ti-di2)" />
...
function MasterIcon() {
  return (
    <>
      <defs>
        <linearGradient id="ti-ma" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#FDF4FF" /><stop offset="30%" stopColor="#E879F9" /><stop offset="100%" stopColor="#701A75" /></linearGradient>
        <linearGradient id="ti-ma2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#86198F" /><stop offset="100%" stopColor="#4A044E" /></linearGradient>
      </defs>
...
function ChampionIcon() {
  return (
    <>
      <defs>
        <linearGradient id="ti-ch" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#FEF08A" /><stop offset="50%" stopColor="#F97316" /><stop offset="100%" stopColor="#DC2626" /></linearGradient>
      </defs>
      <path d="M15 85 L85 85 L95 40 L70 60 L50 20 L30 60 L5 40 Z" fill="url(#ti-ch)" />
...
export default function TierIcon({ tier = 'unranked', size = 'md', className = '' }) {
  ...
  return (
    <svg
      ...
      width={px}
      height={px}
      className={`drop-shadow-[0_4px_12px_${colors.secondary}66] ${className}`}
      style={{ filter: `drop-shadow(0 4px 12px ${colors.secondary}66)` }}
    >
      <IconComponent />
    </svg>
  );
