...
import { AntiAirInterior, ArmoredInterior, HowitzerInterior, MotorcycleInterior, SedanInterior, SuvInterior, TankInterior, TruckInterior } from './VehicleInteriors.jsx';
import ConvertibleCabin from './ConvertibleCabin.jsx';
import AirshipCabin from './AirshipCabin.jsx';
import CoupeCabin from './CoupeCabin.jsx';
import SupercarCabin from './SupercarCabin.jsx';
import ElectricCabin from './ElectricCabin.jsx';
...
const COCKPITS = {
  drift: ConvertibleCabin, airship: AirshipCabin,
  ...
  sedan: SedanInterior, motorcycle: MotorcycleInterior, suv: SuvInterior,
  convertible: ConvertibleCabin, coupe: CoupeCabin, supercar: SupercarCabin, electric: ElectricCabin,
  formula: FormulaInterior, truck: TruckInterior,
 ...
 * 그 ref 를 읽는다. wheelsRef 는 매 프레임 조향용, aimRef 는 전투 차량 포탑용,
 * controlsRef 는 항공기 조종간용이다.
...
export default function Cockpit({ rideKey, statusRef, wheelsRef, controlsRef, poseRef, aimRef, night = false, quality = 'medium', weather = 'clear' }) {
  ...
  return <group userData={COCKPIT_ROOT}>
    <StaticBatch version={`${rideKey}:${night}:${quality}`}>
      <Interior rideKey={rideKey} statusRef={statusRef} wheelsRef={wheelsRef} controlsRef={controlsRef} poseRef={poseRef}
